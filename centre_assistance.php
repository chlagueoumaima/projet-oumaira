...
<body bgcolor="#2874A6" TEXT="white" vlink="white" alink="white" link="white">
	...
	<ul type="square">
            ...
            <a href="#compte"><li>Gérer votre compte</li></a><br/>
            <a href="#securite"><li>Sécurité et protection</li></a><br/>
            <a href="#regles"><li>Règles et politiques</li></a><br/>
    </ul>
<br/><br/>
<br/><br/>
<br/><br/>
...
<hr width="75%">
<p>
Vous pouvez entamer une conversation privée avec n'importe lequel de vos abonnés ou créer une conversation de groupe avec des utilisateurs qui vous suivent.
Toute personne que vous ne suivez pas peut vous envoyer un Message Privé si :
vous avez choisi de recevoir des Messages Privés de la part de n'importe quel utilisateur ;
ou vous avez précédemment envoyé un Message Privé à cette personne.
Tout participant à une conversation peut envoyer des Messages Privés au groupe. Chaque utilisateur d'un groupe peut voir tous les messages, même si tout le monde ne se suit pas mutuellement.
Dans une conversation de groupe, chaque participant peut en ajouter d'autres. Les participants nouvellement ajoutés ne voient pas l'historique de la conversation.
Certains comptes, notamment des entreprises présentes sur Izone, ont activé un paramètre leur permettant de recevoir des Messages Privés de tous les utilisateurs. Vous pouvez donc adresser un Message Privé à ces comptes même s'ils ne vous suivent pas.
...
<ul type="circle">
<li>Avec qui mes informations sont‑elles partagées ?</li>
<li>Quel type et quelle quantité d'informations suis‑je sur le point de partager ?</li>
<li>À combien d'utilisateurs mes informations sont‑elles accessibles ?</li>
<li>Puis‑je me fier à l'ensemble des personnes qui disposent d'un accès à ces informations ?</li></ul>
<p>La notion de confidentialité est spécifique à chaque individu. Chacun est libre de partager ce qu'il veut. Si l'un de vos amis ou une connaissance a publié des informations que vous jugez confidentielles, contactez cette personne et demandez‑lui de retirer le contenu. De la même manière, respectez le souhait des autres utilisateurs. Si, après avoir publié des informations relatives à un autre utilisateur, ce dernier vous demande de les retirer, respectez sa demande. Cet article explique comment supprimer un Tweet.</p>
