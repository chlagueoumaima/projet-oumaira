...
<br>
<a href="#suivant1"  class="sui">Suivant</a>
...
<br>
 <div class="pass">  	
	...
	<div class="form-group">
			<input type="password" name="password" required="required" pattern="a-z A-Z 0-9]{8,}" placeholder="mot de passe" class="form-control" id="motdepasse" title="le code doit contient des lettres minuscules,majuscules et des chiffres">
		</div>
			<br>
			  <div class="form-group form-check">
    <label class="form-check-label">
		...
		<br>
<a href="#suivant2"  class="sui">Suivant</a>
...
<br>
    <a href="#suivant3" class="sui">Suivant</a>
  <br> 
...
<div class="tet">
    ...
    <br>
    <a href="#suivant4"  class="sui">Suivant</a>
...
<div class="content">
    ...
    <button id="bot" type="submit" class="sui">S'inscrire</button>    
  </div>
